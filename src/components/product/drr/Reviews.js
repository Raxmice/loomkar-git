...
export default function Reviews() {
  ...
  const { wrightreview } = context;
  // console.log(wrightreview)
  if(wrightreview === ""){console.log("this is line is just for to not show ACTIVEREVIEWS not used")}
  ...
  return (
    ...
    <div className='reviews-dra'>
        <div className='give-review'>
          ...
          <div className='review-btn'><div className='all-center'><div className='action-btn writebtn'  onClick={writecliked}>WRITE A REVIEW</div></div></div>
        </div>
